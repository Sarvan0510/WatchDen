...
import org.springframework.messaging.simp.SimpMessageHeaderAccessor; // 👈 Import
...
public class ChatController {
    ...
    public void joinRoom(@DestinationVariable String roomId, 
                         ...
                         SimpMessageHeaderAccessor headerAccessor) { // 👈 Accessor needed
        ...
        // 2. Add to Redis Set (Unique list of users)
