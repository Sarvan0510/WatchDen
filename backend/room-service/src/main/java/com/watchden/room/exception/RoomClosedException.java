...
public class RoomClosedException extends RuntimeException {
	...
	public RoomClosedException(Throwable cause) {
		super(cause);
		// TODO Auto-generated constructor stub
	}
	...
	public RoomClosedException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
